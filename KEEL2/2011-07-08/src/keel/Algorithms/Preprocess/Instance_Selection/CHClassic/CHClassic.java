 ...
 * File: CHC.java
 * 
 * The CHClassic evolutionary model for Instance Selection.
 * 
...
package keel.Algorithms.Preprocess.Instance_Selection.CHClassic;
...
public class CHClassic extends Metodo {
	...
	*
    */
	public CHClassic (String ficheroScript) {
		super (ficheroScript);
	...
	public void ejecutar () {
		...
		System.out.println("CHClassic "+ relation + " " + (double)(System.currentTimeMillis()-tiempo)/1000.0 + "s");
