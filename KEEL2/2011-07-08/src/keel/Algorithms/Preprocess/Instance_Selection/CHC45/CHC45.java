...
public class CHC45 extends Metodo {
   ...
   */
  public CHC45 (String ficheroScript) {
    // distanceEu=false;
  ...
  public void ejecutar () {
    ...
    for (i=0; i<tamPoblacion; i++)
      poblacion[i].evalua(myC45, TrainModel, alfa, nClases);
    ...
    while (ev < nEval) {
      ...
      for (i=0; i<newPob.length; i++) {
        newPob[i].evalua(myC45, TrainModel, alfa, nClases);
    ...
    System.out.println("CHC45 "+ relation + " " + (double)(System.currentTimeMillis()-tiempo)/1000.0 + "s");
