...
package keel.Algorithms.Preprocess.Instance_Selection.CHC45_2;
...
public class CHC45_2 extends Metodo {
   ...
   */
  public CHC45_2 (String ficheroScript) {
    // distanceEu=false;
  ...
  public void ejecutar () {
    ...
    for (i=0; i<tamPoblacion; i++)
      poblacion[i].evalua(myC45, TrainModel,TreeSize, alfa, nClases);
    ...
    while (ev < nEval) {
      ...
      for (i=0; i<newPob.length; i++) {
        newPob[i].evalua(myC45, TrainModel,TreeSize, alfa, nClases);
    ...
    System.out.println("CHC45_2 "+ relation + " " + (double)(System.currentTimeMillis()-tiempo)/1000.0 + "s");
