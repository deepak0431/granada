 ...
 * Class to implement the C4.5 algorithm
   @author Crist�bal Romero Morales (UCO) (30-03-06)
...
public class C45 extends Algorithm {
    ...
    /** Constructor 
     *
     * @param confArray         Configuration array.
     *
     * @throws Exception	If the algorithm cannot be executed.
     */
    public C45(Vector confArray) {
        ...
        minItemsets = (Integer) confArray.get(4);
     ...
     *
     * @return          The percentage of correctly classified items.
     * 
    ...
    public float evaluateCromosoma() {
        ...
        // a questo punto ho il numero di correttamente classificati dentro la
