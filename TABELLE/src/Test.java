			...
			for (j=0; j<datasets.size(); j++) {
				...
				for (k=0; k<10; k++) {
					...
					if(configAct >0){
						...
						cadena = Fichero.leeFichero("results//Clas-KNN//"+alAct+"//result"+Integer.toString((j+salAct)*10+k)+".tra");
					}
                                        System.out.println(datasets.get(j));
                                        System.out.println(cadena);
                                        System.out.println("results\\"+alAct+"."+datasets.get(j)+"\\result"+Integer.toString(k)+"s0.tra");
				...
				//	System.out.println(accV[k]);
					...
					if(configAct >0){
						...
						cadena = Fichero.leeFichero("results//Clas-KNN//"+alAct+"//result"+Integer.toString((j+salAct)*10+k)+"e0.txt");
					}
			...
			for (j=0; j<datasets.size(); j++) {
				...
				for (k=0; k<10; k++) {
					...
					if(configAct >0){
						...
						cadena = Fichero.leeFichero("results//Clas-KNN//"+alAct+"//result"+Integer.toString((j+salAct)*10+k)+".tst");
					}
