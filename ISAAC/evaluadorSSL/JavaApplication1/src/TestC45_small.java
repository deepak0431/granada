...
public class TestC45_small {
    ...
    public static void main(String[] args) throws IOException, WriteException {
            ...
            for (int i=0; i<algoritmos.size(); i++) {
                    ...
                    for (int j=0; j<datasets.size(); j++) {
                            ...
                            for (int k=0; k<10; k++) {
                                    ...
                                    //System.out.println("SMALL\\resultsC45\\"+alAct+"."+datasets.get(j)+"\\result"+Integer.toString(k)+".tst");
                                    //System.out.println(cadena);
                                    lineas = new StringTokenizer (cadena, "\n\r");
            ...
            for (int i=0; i<algoritmos.size(); i++) {
                    ...
                    for (int j=0; j<datasets.size(); j++) {
                            ...
                            for (int k=0; k<10; k++) {
                                    ...
                                    //System.out.println(datasets.get(j));
                                    //System.out.println(cadena);
                                    //System.out.println("SMALL\\resultsC45\\"+alAct+"."+datasets.get(j)+"\\result"+Integer.toString(k)+".tra");
                                    //System.out.println(cadena);
                                    lineas = new StringTokenizer (cadena, "\n\r");
		...
		cadena = "\n";
		Fichero.escribeFichero("SMALL\\Tablas\\C45\\TablaC45.txt", cadena);
        ...
        private static void write_table_excel() throws IOException, WriteException{
            ...
            tabla.setOutputFile("SMALL\\Tablas\\C45\\ExcelC45_small.xls");
        ...
        private static void writeTable_Bests()throws IOException, WriteException{
           MyExcelWriter tabla = new MyExcelWriter();
           tabla.setOutputFile("SMALL\\Tablas\\C45\\ExcelC45_smallBests.xls");
           tabla.create("tablaC45");
           ...
           for (int i=0; i<datasets.size(); i++){
               ...
               for(int j=0;elem_dataset_rank[j].getValue()<=ranks_matr[i][0];j++){
                   ...
                   tabla.addString12pt(j*9+4, 0, "Red");
               }
            }
            tabla.write();
        }
		...
		cadena = "";
		Fichero.escribeFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_tst.csv", cadena);
                cadena = "Test";
                for(int j=0;j<sel_alg.size();j++){
                ...
                cadena += "\n";
                Fichero.AnadirtoFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_tst.csv", cadena);
        }
        private static void writeCSV_ISRed() throws IOException, WriteException{
		cadena = "";
		Fichero.escribeFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_ISRed.csv", cadena);
                cadena = "ISRed";
                for(int j=0;j<sel_alg.size();j++){
                cadena += "," + sel_alg.elementAt(j);
                }
                ...
                cadena += "\n";
                Fichero.AnadirtoFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_ISRed.csv", cadena);
        }
        private static void writeCSV_Size() throws IOException, WriteException{
		cadena = "";
		Fichero.escribeFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_Size.csv", cadena);
                cadena = "Size";
                for(int j=0;j<sel_alg.size();j++){
                cadena += "," + sel_alg.elementAt(j);
                }
                ...
                cadena += "\n";
                Fichero.AnadirtoFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_Size.csv", cadena);
        }
        
        private static void writeCSV_ISRedTst() throws IOException, WriteException{
		cadena = "";
		Fichero.escribeFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_ISRedTst.csv", cadena);
                cadena = "ISRedTst";
                for(int j=0;j<sel_alg.size();j++){
                cadena += "," + sel_alg.elementAt(j);
                }
                ...
                cadena += "\n";
                Fichero.AnadirtoFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_ISRedTst.csv", cadena);
        }
        private static void writeCSV_RedSizeTst() throws IOException, WriteException{
		cadena = "";
		Fichero.escribeFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_RedSizeTst.csv", cadena);
                cadena = "RedSizeTst";
                for(int j=0;j<sel_alg.size();j++){
                cadena += "," + sel_alg.elementAt(j);
                }
                ...
                cadena += "\n";
                Fichero.AnadirtoFichero("SMALL\\Tablas\\C45\\CSV\\C45_small_RedSizeTst.csv", cadena);
        }
        ...
        public static void writeExcel_tst() throws IOException, WriteException{
            MyExcelWriter tabla = new MyExcelWriter();
            tabla.setOutputFile("ExcelC45_small_tst.xls");
            tabla.create("tablaC45");
            for(int j=0;j<sel_alg.size();j++){
        ...
        */
        ...
        private static void writeTableAvg()throws IOException, WriteException{
            ...
            MyExcelWriter tabla = new MyExcelWriter();
            tabla.setOutputFile("SMALL\\Tablas\\C45\\ExcelC45_avg_small.xls");
            tabla.create("tablaC45");
        ...
        private static void writeTableAvg_rank()throws IOException, WriteException{
            ...
            MyExcelWriter tabla = new MyExcelWriter();
            tabla.setOutputFile("SMALL\\Tablas\\C45\\ExcelC45_Rank_small.xls");
            tabla.create("tablaC45");
